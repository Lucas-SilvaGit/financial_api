...
DeviseTokenAuth.setup do |config|
  ...
  # By default this value is expected to be sent by the client so that the API knows where to redirect users 
  # after successful password resets. If this param is set, the API will redirect to this value 
